...
public class Point implements Comparable<Point> {
  ...
  public double slopeTo(Point that) {
    ...
    int y1 = that.y;
    // equal
    if (x == x1 && y == y1) return Double.NEGATIVE_INFINITY;
      // vertical
    else if (x == x1) return Double.POSITIVE_INFINITY;
      // horizontal
    else if (y == y1) return +0.0;
    else return (double) (y1 - y) / (x1 - x);
  }
  ...
  public Comparator<Point> slopeOrder() {
    /* YOUR CODE HERE */
    // avoid floating round off error
  ...
  public static void main(String[] args) {
    ...
    System.out.println("p1.compareTo(p2) is " + p1.compareTo(p2));
